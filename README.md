 ...
 * medgemma-builder-notebook.ipynb: [The Data Engineering Layer] * Covers the end-to-end pipeline of embedding generation and FAISS indexing.
   * Implements the logic to construct the four-branch clinical tree (STATE, EMOTION, CONCERN, RISK).
 * medgemma-app-notebook.ipynb: [The Application Layer] * Features the inference engine and the RAG-grounding logic.
